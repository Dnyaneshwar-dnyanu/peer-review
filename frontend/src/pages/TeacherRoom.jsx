...
function ClassroomPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-blue-500 to-cyan-500 p-6 relative">
          ...
          <div className="mt-5">
            {
              room && room.status === "OPEN" ?
                <button onClick={closeRoom} className="px-5 py-2 bg-white text-indigo-600 rounded-lg font-semibold hover:bg-gray-200 cursor-pointer">
                  Close Room
                </button>
                :
                <button onClick={openRoom} className="px-5 py-2 bg-white text-indigo-600 rounded-lg font-semibold hover:bg-gray-200 cursor-pointer">
                  Open Room
                </button>
            }
          </div>
      ...
      <div className="max-h-[90vh] w-full flex justify-between gap-4 p-3 px-5 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl">
        ...
        <div className="w-[60%]">
          ...
          <div className="bg-white/20 rounded-md max-h-[94%] overflow-auto">
            {
              !selectedProject ?
