...
function TeacherDashboard() {
     ...
     const getUser = async () => {
          let res = await fetch('http://localhost:3000/admin/getData', {
               method: 'GET',
               credentials: 'include'
          });
          ...
          <div className='min-h-screen bg-gradient-to-br from-indigo-600 via-blue-500 to-cyan-500 flex'>
               ...
               <div className="w-64 p-6 bg-white/10 backdrop-blur-xl border-r border-white/20">
                    ...
                    <ul className="flex flex-col gap-6 text-white text-lg">
                         ...
                         <li className="flex items-center gap-3 mt-10 text-red-200 hover:text-red-100 cursor-pointer">
                              <FaSignOutAlt /> Logout
                         </li>
                    </ul>
               </div>
          ...
          ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         ...
                         <Link to='/admin/createRoom'>
                              <div className="
            p-6 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 
            hover:scale-[1.02] transition shadow-md flex flex-col justify-center items-center gap-3 text-2xl cursor-pointer
          ">
                                   <IoMdAdd className="text-3xl" />
                                   <p>Click to Create Classroom</p>
                              </div>
                         </Link>
                    </div>
               </div>
